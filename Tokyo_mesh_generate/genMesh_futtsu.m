...
%    addpath([basedir,'pipeline/01_pre_pro/00_data/']);
    ...
    addpath([basedir,'OceanMesh2D/datasets/Tokyo_Bay_shp/Tokyo_coastline/Wang_coastline']);
    addpath([basedir,'OceanMesh2D/datasets/Tokyo_Bay_shp/Tokyo_coastline/Futtsu_coastline']);
    addpath([basedir,'OceanMesh2D/datasets/Tokyo_dem']);
...
min_el_05    = 8;  		% minimum resolution in meters.
