...
min_el_03    = 3e2;  		% minimum resolution in meters.
...
coastline_03 = 'C23-06_TOKYOBAY_OUTER'; 
...
max_el_04    = 9e2; 		% maximum resolution in meters. 
wl_04        = 10;
dt_04        = 0;
...
coastline_04 = 'C23-06_TOKYOBAY_INNER'; 
dem_04       = dem_03;
...
min_el_05    = 10;  		% minimum resolution in meters.
...
x_bond_05 = [139.863022 139.860791 139.846452 139.825677 ...
          139.816751 139.812288 139.808598 139.806454 ...
          139.805253 139.806113 139.852028 139.863022];
y_bond_05 = [35.344818 35.348390 35.343771 35.336488 ...
          35.332006 35.328434 35.323951 35.318979 ...
          35.316528 35.311696 35.318211 35.344818];
...
m = interp(m,{gdat_01 gdat_02 gdat_03 gdat_04 gdat_05},'mindepth',5.0); % interpolate bathy to the mesh with minimum depth of 1 m
...
plot(m,'type','bd');
plot(gdat_01, 'dem');
save('tokyobay_futtsu5.0','m');  
write(m,'tokyobay_futtsu5.0');
